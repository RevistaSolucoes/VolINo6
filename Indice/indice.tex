...
\rowcolor{cscccccc}
Solução em ação: Luis Arantes Lemos de Azevedo &  {\fontsize{50}{50}\selectfont 2}\\
\rowcolor{csccccc}
Matemática em engenharia: Análise harmónica & \\
\rowcolor{csccccc}
clássica, Parte II & {\fontsize{50}{50}\selectfont 3}\\
\rowcolor{cscccc}
Informática en ingeniería: aplicaciones en \emph{Octave} & {\fontsize{50}{50}\selectfont 9}\\
\rowcolor{csccc}
Novedades:  & {\fontsize{50}{50}\selectfont 16}\\
\rowcolor{cscc}
