...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [yshift=3.25cm] at (current page.center) 
      {\color{redsol}\fontsize{1.2cm}{1em}
        \includegraphics[width=0.7\linewidth]{AnagramaOriginal_Saema.pdf}
        };
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node [yshift=7.5cm, xshift=1cm, 
    ...
    {\color{white}
      ...
      {\color{white}
        \begin{tabular}[l]{ll}
          \textcopyright & 2014 Sumbe Factory S.L. Publicaciones Saema, Projectos na Área Eléctrica 
          e Médica, lda\\
           & C/ Deolinda Rodrigues S/N -- Luanda -- Angola MUNDIAL\\
